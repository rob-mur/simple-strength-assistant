...
- [x] **DB-03**: Selected file handle persists across browser sessions (via IndexedDB)
- [x] **DB-04**: User can grant File System Access API permissions when prompted
- [x] **DB-05**: Database initialization completes successfully after file selection
- [x] **DB-06**: LocalStorage fallback works when File System Access API unavailable
...
- [x] **ERR-03**: File format validation errors are surfaced to user
...
_Last updated: 2026-02-26 after completing v1.0 milestone_
