...
export async function retrieveFileHandle() {
  try {
    ...
    console.log(
      "[FileHandleStorage] Handle found, checking permission state...",
    );
    ...
    if (permission === "granted") {
      console.log(
        "[FileHandleStorage] Permission granted, handle ready to use",
      );
      return handle;
    }
    ...
    if (permission === "prompt") {
      ...
      try {
        ...
        console.log(
          "[FileHandleStorage] Permission request result:",
          requestedPermission,
        );
    ...
    // permission === 'denied'
    console.warn(
      "[FileHandleStorage] Permission permanently denied, clearing stale handle",
    );
    await clearFileHandle();
    return null;
  } catch (error) {
