...
<task type="auto">
  <name>Task 1: Define BDD Feature for Momentum and Snapping</name>
  <files>tests/features/tape_measure_physics.feature</files>
  <action>
    - Write Gherkin scenarios for:
        1. "Momentum glide" (release at velocity > threshold triggers friction decay).
        2. "Snapping" (stopping near an increment centers the value).
        3. "Edge resistance" (hard wall at min/max).
        4. "Tap to stop" (tap during glide stops motion and snaps).
  </action>
  <verify>
    File `tests/features/tape_measure_physics.feature` exists and contains physics-specific Gherkin scenarios.
  </verify>
  <done>
    BDD scenarios for momentum and snapping defined.
  </done>
</task>

<task type="checkpoint:human-verify" gate="blocking">
  <what-built>BDD Feature Scenarios for TapeMeasure physics (momentum, snapping).</what-built>
  <how-to-verify>
    Review the content of `tests/features/tape_measure_physics.feature` and approve the scenarios for physics behavior.
  </how-to-verify>
  <resume-signal>Type "approved" or describe issues</resume-signal>
</task>

<task type="auto">
  <name>Task 3: Implement Momentum Glide and Snapping Loop</name>
...
<task type="auto">
  <name>Task 4: Implement SVG Rendering with Dynamic Opacity</name>
  <files>src/components/tape_measure.rs</files>
  <action>
...
<task type="auto">
  <name>Task 5: Implement Click-to-Jump and Edge Resistance</name>
  <files>src/components/tape_measure.rs</files>
  <action>
