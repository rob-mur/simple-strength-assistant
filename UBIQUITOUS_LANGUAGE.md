...
> **Domain expert:** "RPE is what the trainee *reported* for a completed Set — it's an observation. Target RPE is a Setting — the intensity the algorithm aims for when projecting a Suggestion. They're separate concepts."
